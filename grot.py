...
parser.add_argument("--userinfo", action="store_true", help="Print username info")
...
parser.add_argument("-r", "--repo", type=str, help="Limit search to the repo provided")
...
def download_and_extract_repo_data(name, url, restore_branch):
    if repo is None or repo in url:
        print("--------------------------- PARSING REPO ----------------------")
